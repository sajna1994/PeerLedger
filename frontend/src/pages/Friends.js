...
const Friends = () => {
  ...
  return (
    <div className="px-2 sm:px-4">
      <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4 sm:mb-8">External Contacts</h1>
                ...
                {externalParties.length > 0 ? (
                  ...
                  <div className="text-center py-6 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-500">
                      No external contacts yet. Add them when creating a transaction.
                    </p>
                  </div>
                )}
              </div>
